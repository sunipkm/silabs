...
#define SI446X_SENT_CB _BV(5 + 8)	///< Enable/disable packet send complete callback
#define SI446X_RXCOMPLETE_CB _BV(4 + 8) ///< Enable/disable packet receive complete callback
#define SI446X_RXINVALID_CB _BV(3 + 8)	///< Enable/disable packet invalid callback
#define SI446X_RXBEGIN_CB _BV(0)	///< Enable/disable packet receive start callback
